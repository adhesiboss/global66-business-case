...
- Proxy `/api/*` hacia backend (opcional / recomendado para SSR)
...
- Morgan (logging)
- CORS
- Integración preparada para Google Sheets (con fallback mock)

---

# ☁️ Deploy (Live)

- **Front (Nuxt SSR):** https://global66-business-case-front.onrender.com  
- **Back (Express API):** https://global66-business-case-back.onrender.com  

### Smoke tests (Live)

```bash
# Health
curl -i https://global66-business-case-back.onrender.com/health

# Rates (mock)
curl -i "https://global66-business-case-back.onrender.com/api/rates?base=USD&target=CLP"

# SSR (verifica title y contenido SSR)
curl -s https://global66-business-case-front.onrender.com/precio/peso-chileno | grep -i "<title"
curl -s https://global66-business-case-front.onrender.com/precio/peso-chileno | grep -i "1 USD"
```
...
- Backend (Express API + validaciones + errores + logging + lead capture): ~1.5h
